...
struct Api_DriverEarnings : Codable {
    let driver_today_earning : String?
    let driver_total_earning : String?
    let result : [Res_DriverEarnings]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([Res_DriverEarnings].self, forKey: .result)
...
struct Res_DriverEarnings : Codable {
    let id : String?
    let user_id : String?
