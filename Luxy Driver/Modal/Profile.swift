...
struct ResProfile : Codable {
    ...
    let Driver_today_earning : String?
    let request_count : String?
    let upcomming_request_status: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case Driver_today_earning = "Driver_today_earning"
        case request_count = "request_count"
        case upcomming_request_status = "upcomming_request_status"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        Driver_today_earning = try values.decodeIfPresent(String.self, forKey: .Driver_today_earning)
        request_count = try values.decodeIfPresent(String.self, forKey: .request_count)
        upcomming_request_status = try values.decodeIfPresent(String.self, forKey: .upcomming_request_status)
    }
}
