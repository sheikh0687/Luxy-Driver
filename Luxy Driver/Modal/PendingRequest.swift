...
struct ApiDriverPendingReq : Codable {
    
    let result : [ResPendingRequest]?
    let message : String?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResPendingRequest].self, forKey: .result)
...
struct ResPendingRequest : Codable {
    let id : String?
    let user_id : String?
    ...
    let ride_distance : String?
    let ride_time : String?
    let req_remain_long_time : Int?
    let admin_set_request_time : Int?
    let user_details : Pending_User_details?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case admin_set_request_time = "admin_set_request_time"
    ...
    init(from decoder: Decoder) throws {
        ...
        ride_distance = try values.decodeIfPresent(String.self, forKey: .ride_distance)
        ...
        admin_set_request_time = try values.decodeIfPresent(Int.self, forKey: .admin_set_request_time)
        user_details = try values.decodeIfPresent(Pending_User_details.self, forKey: .user_details)
        user_request_stop = try values.decodeIfPresent([User_request_stop].self, forKey: .user_request_stop)
    }

}

struct Pending_User_details : Codable {
    let id : String?
    let vehicle_id : String?
    let vehicle_name : String?
